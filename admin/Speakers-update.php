...
if(isset($_POST["pres_id"]) && !empty($_POST["pres_id"])){
    ...
    $stmt = $pdo->prepare("UPDATE Speakers SET speaker_id=?,bio=?,picture=? WHERE pres_id=?");

    if(!$stmt->execute([ $speaker_id,$bio,$picture,$pres_id  ])) {
        echo "Something went wrong. Please try again later.";
        header("location: error.php");
    } else {
        $stmt = null;
        header("location: Speakers-read.php?pres_id=$pres_id");
    }
} else {
