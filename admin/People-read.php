                ...
                <div class="col-md-8 mx-auto">
                    <div class="page-header">
                     ...
                     <div class="form-group">
                            ...
                            <h4>org_name</h4>
                            <p class="form-control-static"><?php echo $row["org_name"]; ?></p>
                        </div><div class="form-group">
                            <h4>is_presenter</h4>
                            <p class="form-control-static"><?php echo $row["is_presenter"]; ?></p>
                        </div>

                    <p><a href="People-index.php" class="btn btn-primary">Back</a></p>
                </div>
            </div>
        </div>
    </section>
